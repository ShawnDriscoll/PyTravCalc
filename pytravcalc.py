...
#                 self.total_damage = 1
    ...
    def update_graph(self):
        ...
        ticks_font = font_manager.FontProperties(style='normal', size=12, weight='normal', stretch='normal')
        for label in self.mpl.canvas.ax.get_xticklabels():
            label.set_fontproperties(ticks_font)
        title_font = font_manager.FontProperties(style='normal', size=6, weight='normal', stretch='normal')
