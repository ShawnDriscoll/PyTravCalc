...
import time
from mainwindow_320b import Ui_MainWindow
from aboutdialog_320b import Ui_aboutDialog
from alertdialog_320b import Ui_alertDialog
...
__app__ = 'PyTravCalc 3.2.0 Beta'
__version__ = '3.2.0b'
__py_version__ = '3.9.7'
__expired_tag__ = False

#form_class = uic.loadUiType("mainwindow_320b.ui")[0]
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        #uic.loadUi("mainwindow_320b.ui", self)
...
#                         filemode = 'w')
    ...
    log = logging.getLogger('PyTravCalc320b')
    ...
    if len(sys.argv) < 2:
        ...
        print("     C:\>PyTravCalc320b.py roll('2d6')")
        print()
        print('     Or just:')
        print('     C:\>PyTravCalc320b.py 2d6')
