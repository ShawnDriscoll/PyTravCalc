...
class Ui_aboutDialog(object):
    ...
    def retranslateUi(self, aboutDialog):
        ...
        aboutDialog.setWindowTitle(_translate("aboutDialog", "About TravCalc"))
        self.aboutOKButton.setText(_translate("aboutDialog", "OK"))
        self.textLabel.setText(_translate("aboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">TravCalc for Windows XP/7/8/10</span></p><p>Version: Mongoose Traveller 2nd Edition</p><p>Build: 3.1.0 (Beta)</p><p>Produced by Shawn Driscoll. Copyright (C) 2021.</p><p>Get the latest manual at <a href=\"https://pytravcalcmanual.readthedocs.io/en/latest/\"><span style=\" text-decoration: underline; color:#0000ff;\">Read the Docs</span></a><br/>Visit blog at <a href=\"http://shawndriscoll.blogspot.com\"><span style=\" text-decoration: underline; color:#0000ff;\">shawndriscoll.blogspot.com</span></a><br/>For support, email <a href=\"mailto:shawndriscoll@hotmail.com?subject=TravCalc 3.1.0 (Beta) for Mongoose Traveller 2nd Edition\"><span style=\" text-decoration: underline; color:#0000ff;\">shawndriscoll@hotmail.com</span></a></p><p>Qt GUI Toolkit is copyright (C) 2020 The Qt Company Ltd</p><p><br/></p><p>The Traveller game in all forms is owned by Far Future Enterprises. Copyright 1977 - 2021 Far Future Enterprises. Traveller is a registered trademark of Far Future Enterprises.</p></body></html>"))
