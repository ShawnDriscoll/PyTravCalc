...
Running PyTravCalc
------------------
If you have Python 3.9.7 installed, you can start ``pytravcalc315b.py`` from a CMD prompt or double-click
the Python script.

Alternatively, if you do not have Python 3.9.7, you can start ``pytravcalc315b.exe`` from a CMD prompt or by double-clicking
